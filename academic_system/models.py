...
class Ciclo(models.Model):
    ...
    def puede_matricularse(self):
        from academic_system.services.ciclo_state import CicloStateFactory

        """

        Strategy Pattern: Validacin de si se puede matricular.

        STATE PATTERN: delega al estado actual del ciclo (abierto/cerrado/terminado).

        Information Expert: El ciclo conoce su estado de matrcula.

        """

        return CicloStateFactory.from_ciclo(self).puede_matricularse()
